...
import { Wifi, WifiOff, Trash2, Globe, Smartphone, MoreVertical, QrCode, Hash } from 'lucide-react';
...
export default function AccountCard({ account, onDelete, onDisconnect, onReconnect, isSelected, onSelect, selectionMode }: AccountCardProps) {
