...
export default function ConditionEqualsNode({ id, data, isConnectable }: any) {
  const { t } = useLanguage();
  ...
  return (
    <Card className="w-[220px] border-0 shadow-md rounded-md overflow-hidden ring-1 ring-slate-200 dark:ring-slate-700 bg-white dark:bg-slate-900">
      ...
      <Handle type="target" position={Position.Top} isConnectable={isConnectable} className="!bg-blue-600 !w-2 !h-2 !border !border-white" />
      
      <CardHeader className="p-2 pb-1.5 bg-blue-50/50 dark:bg-blue-900/10 border-b border-blue-100 dark:border-blue-900/20">
        <CardTitle className="text-xs font-semibold flex items-center gap-1.5 text-blue-800 dark:text-blue-300">
      ...
      <CardContent className="p-2 space-y-1.5">
        ...
        >
          <Input 
            ...
            className="text-xs h-7 bg-slate-50 dark:bg-slate-950 border-slate-200 focus-visible:ring-blue-600"
          />
        </div>
