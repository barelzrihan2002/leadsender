...
export type CampaignContactResultCode = 'added' | 'invite_sent' | 'not_admin' | 'already_in_group' | 'privacy_restricted' | 'not_registered' | 'recently_left' | 'community_restricted' | 'group_full' | 'account_not_connected' | 'group_not_found' | 'group_access_denied' | 'unknown_error';
...
export interface Campaign {
    ...
    messages_before_break?: number;
    break_duration?: number;
    skip_recent_contacts?: boolean;
...
export interface ElectronAPI {
    ...
    campaigns: {
        ...
        setContacts: (id: string, contacts: {
            phone_number: string;
        }[]) => Promise<void>;
    ...
    contacts: {
        ...
        checkDuplicates: (filePath: string, country: string) => Promise<{
            duplicateCount: number;
            totalCount: number;
            duplicates: string[];
        }>;
        previewFile: (filePath: string, country: string) => Promise<{
            preview: any[];
            totalCount: number;
        }>;
    ...
    groupCampaigns: {
        ...
        create: (data: Partial<GroupCampaign> & {
            targets: GroupCampaignTarget[];
        }) => Promise<GroupCampaign>;
        update: (id: string, data: Partial<GroupCampaign> & {
            targets?: GroupCampaignTarget[];
        }) => Promise<GroupCampaign>;
        delete: (id: string) => Promise<void>;
        start: (id: string) => Promise<void>;
    ...
    messages: {
        ...
        getMediaFile: (messageId: string) => Promise<{
            buffer: number[];
            fileName: string;
        } | null>;
        getChatPhoto: (photoPath: string) => Promise<{
            buffer: number[];
            fileName: string;
        } | null>;
    };
    ...
    templates: {
        ...
        delete: (id: string) => Promise<void>;
        getMediaFile: (mediaPath: string) => Promise<{
            buffer: number[];
            fileName: string;
        } | null>;
    };
